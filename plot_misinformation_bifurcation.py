...
def sample(eigs_bool = False):
    ...
    """
    PC, par_dict, ss_dict, data = plot_misinformation_bifurcation(par_dict=eq1_risk_h1_par_dict, ics_dict=eq1_risk_h1_ss,
    ...
    PC, par_dict, ss_dict, data = plot_misinformation_bifurcation(par_dict=eq1_risk_h1_par_dict,
                                                                  ics_dict=eq1_risk_h1_ss,
                                                                  special_point='H2', tend=20_000, eps0=0.05)
