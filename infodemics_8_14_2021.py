...
def plot_nullclines(option='A', PTS='', par_dict=eq1_h1_par_dict, ss_dict=eq1_h1_ss, n_bin=100, xlow=0, xhigh=1.0,
                        ...
                        par_dict_2=eq1_lp1_par_dict, evecs_bool=False, evecs=None, ics_dict={}, par = 'risk', z0 = ''):
    """
...
z, t = gen_sys(par_dict = par_dict_new, ics_dict = eq1_h1_ss, tf = 20_000)
...
plot_nullclines(option = 'A', PTS = pts, par_dict = par_dict_new, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation', z0 = 0,)
# sb vs ib nullcline
plot_nullclines(option = 'B', PTS = pts, par_dict = par_dict_new, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation', z0 = 0)
# ib vs v nullcline
plot_nullclines(option = 'C', PTS = pts, par_dict = par_dict_new, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation', z0 = 0)
# ib vs v nullcline
...
plot_nullclines(option = 'A', PTS = pts, par_dict = par_dict_new2, ss_dict = ss_new, evecs_bool = False, xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation')
# sb vs ib nullcline
plot_nullclines(option = 'B', PTS = pts, par_dict = par_dict_new2, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation')
# ib vs v nullcline
plot_nullclines(option = 'C', PTS = pts, par_dict = par_dict_new2, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation')
# ib vs v nullcline
#plot_nullclines(option='E', PTS=pts, par_dict=par_dict, ss_dict=ss_dict, evecs_bool=False, xhigh = 1, yhigh = 1, xlow = 0, ylow = 0, n_bin=200, par='education')
...
plot_nullclines(option = 'A', PTS = pts, par_dict = par_dict_new2, ss_dict = ss_new, evecs_bool = False, xhigh = 0.215, yhigh = 0.49, xlow = 0.205, ylow = 0.47, n_bin = 200, par = 'misinformation')
# sb vs ib nullcline
plot_nullclines(option = 'B', PTS = pts, par_dict = par_dict_new2, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation')
# ib vs v nullcline
plot_nullclines(option = 'C', PTS = pts, par_dict = par_dict_new2, ss_dict = ss_new, evecs_bool = False,  xhigh = None, yhigh = None, xlow = None, ylow = None, n_bin = 200, par = 'misinformation')
...
ode = generate_ode(par_dict = eq1_h1_par_dict, ics_dict = eq1_h1_ss, tf = 5_000)
PC_education = generate_education_bifurcation(ode, ics_dict = eq1_h1_ss, par_dict = eq1_h1_par_dict, max_points = 1_000, tend = 5_000) 


# In[60]:


par_dict_h1, ss_dict_h1, data_h1 = get_data(PC_education, curve='EQeducation', special_point='H1', par='education', par_ext='', par_dict=eq1_h1_par_dict)
par_dict_h2, ss_dict_h2, data_h2 = get_data(PC_education, curve='EQeducation', special_point='H2', par='education', par_ext='', par_dict=eq1_h1_par_dict)
...
# --- easy ---
pts = plot_time_perturbed_steady_state(PAR_dict=par_dict_h2, ss_dict=ss_dict_h1, tend=20_000, par='education',
                                     random_bool=True, eps=0.1, par_dict=par_dict_h1)


# In[156]:


plot_nullclines(option = 'A', PTS = pts, par_dict = par_dict_h1, ss_dict = ss_dict_h1, evecs_bool = False, xhigh = 0.4, yhigh = 0.8, xlow = 0, ylow = 0, n_bin = 200, par = 'education')
# sb vs ib nullcline
plot_nullclines(option = 'B', PTS = pts, par_dict = par_dict, ss_dict = ss_dict, evecs_bool = False, xhigh = 1, yhigh = 1, xlow = 0, ylow = 0, n_bin = 200, par = 'education')
# ib vs v nullcline
plot_nullclines(option = 'C', PTS = pts, par_dict = par_dict, ss_dict = ss_dict, evecs_bool = False, xhigh = 1, yhigh = 1, xlow = 0, ylow = 0, n_bin = 200, par = 'education')
# ib vs v nullcline
plot_nullclines(option='E', PTS=pts, par_dict=par_dict, ss_dict=ss_dict, evecs_bool=False, xhigh = 1, yhigh = 1, xlow = 0, ylow = 0, n_bin=200, par='education')
...
PC_risk = generate_risk_bifurcation(ode, ics_dict = eq1_h1_ss, par_dict = eq1_h1_par_dict, max_points = 1_000, tend = 20_000) 
...
pts = plot_time_perturbed_steady_state(PAR_dict=par_dict_lp1, ss_dict=ss_dict_lp1, tend=10_000, par='risk',
                                     random_bool=True, eps=0.0000001, par_dict=par_dict_lp1)


# In[200]:


plot_nullclines(option = 'A', PTS = pts, par_dict = par_dict_lp1, ss_dict = ss_dict_lp1, evecs_bool = False, xhigh = 0.4, yhigh = 0.8, xlow = 0, ylow = 0, n_bin = 200, par = 'risk')
# sb vs ib nullcline
plot_nullclines(option = 'B', PTS = pts, par_dict = par_dict_lp1, ss_dict = ss_dict_lp1, evecs_bool = False, xhigh = 1, yhigh = 1, xlow = 0, ylow = 0, n_bin = 200, par = 'risk')
# ib vs v nullcline
plot_nullclines(option = 'C', PTS = pts, par_dict = par_dict_lp1, ss_dict = ss_dict_lp1, evecs_bool = False, xhigh = 1, yhigh = 1, xlow = 0, ylow = 0, n_bin = 200, par = 'risk')
...
pts = plot_time_perturbed_steady_state(PAR_dict=par_dict_bp1, ss_dict=ss_dict_bp1, tend=20_000, par='risk',
                                     random_bool=True, eps=0.1, par_dict=par_dict_bp1)
